...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "ANJU-XPRO~DI9RRD4C#IX6IgMCFLWz4iePa0bnR7lQTp5GOipvAYP6v6hqXGxU",
    GITHUB_TOKEN: process.env.GITHUB_TOKEN || "github token without ghp_",
    GITHUB_USERNAME: process.env.GITHUB_USERNAME || "dinujaya423",
